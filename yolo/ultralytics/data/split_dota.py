...
from yolo.ultralytics.data.utils import exif_size, img2label_paths
...
def crop_and_save(anno, windows, window_objs, im_dir, lb_dir, allow_background_images=True):
    ...
    Args:
        ...
        im_dir (str): The weight directory path of images.
        lb_dir (str): The weight directory path of labels.
    ...
    Notes:
        The directory structure assumed for the DOTA dataset:
            - data_root
                ...
                - labels
                    - split
        and the weight directory structure is:
            - save_dir
                - images
                    - split
                - labels
