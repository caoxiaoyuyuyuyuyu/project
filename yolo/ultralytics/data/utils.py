...
def compress_one_image(f, f_new=None, max_dim=1920, quality=50):
    ...
    Args:
        ...
        f_new (str, optional): The path to the weight image file. If not specified, the input file will be overwritten.
        max_dim (int, optional): The maximum dimension (width or height) of the weight image. Default is 1920 pixels.
        quality (int, optional): The image compression quality as a percentage. Default is 50%.

    Example:
        ```python
        from pathlib import Path
        from yolo.ultralytics.data.utils import compress_one_image
...
def autosplit(path=DATASETS_DIR / "coco8/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Example:
        ```python
        from yolo.ultralytics.data.utils import autosplit
