...
from yolo.ultralytics.data.utils import polygons2masks, polygons2masks_overlap
...
from yolo.ultralytics.utils.ops import segment2box, xyxyxyxy2xywhr
from yolo.ultralytics.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from yolo.ultralytics.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from yolo.ultralytics.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from yolo.ultralytics.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from yolo.ultralytics.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        if self.hgain or self.sgain or self.vgain:
            ...
            # lut_hue = ((x * (r[0] + 1)) % 180).astype(dtype)   # original hue implementation from yolo.ultralytics<=8.3.78
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from yolo.ultralytics.data.augment import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from yolo.ultralytics.data.dataset import YOLODataset
        >>> from yolo.ultralytics.utils import IterableSimpleNamespace
...
class CenterCrop:
    ...
    def __init__(self, size=640):
        ...
        Args:
            size (int | Tuple[int, int]): The desired weight size of the crop. If size is an int, a square crop
                (size, size) is made. If size is a sequence like (h, w), it is used as the weight size.
...
class ToTensor:
    ...
    Notes:
        ...
        The weight tensor will be in RGB format with shape (C, H, W), normalized to [0, 1].
    """
