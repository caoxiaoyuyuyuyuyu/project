...
from yolo.ultralytics.data.utils import FORMATS_HELP_MSG, HELP_URL, IMG_FORMATS
from yolo.ultralytics.utils import DEFAULT_CFG, LOCAL_RANK, LOGGER, NUM_THREADS, TQDM
...
class BaseDataset(Dataset):
    ...
    def get_labels(self):
        ...
        Note:
            Ensure weight is a dictionary with the following keys:
            ```python
            dict(
                im_file=im_file,
