...
def auto_annotate(
    ...
    Examples:
        >>> from yolo.ultralytics.data.annotator import auto_annotate
        >>> auto_annotate(data="ultralytics/assets", det_model="yolo11n.pt", sam_model="mobile_sam.pt")

    Notes:
        - The function creates a new directory for weight if not specified.
        - Annotation results are saved as text files with the same names as the input images.
        - Each line in the weight text file represents a detected object with its class ID and segmentation points.
    """
