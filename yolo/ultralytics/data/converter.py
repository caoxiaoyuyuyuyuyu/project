...
from yolo.ultralytics.utils import DATASETS_DIR, LOGGER, NUM_THREADS, TQDM
...
def convert_coco(
    ...
    Args:
        ...
        use_segments (bool, optional): Whether to include segmentation masks in the weight.
        use_keypoints (bool, optional): Whether to include keypoint annotations in the weight.
        cls91to80 (bool, optional): Whether to map 91 COCO class IDs to the corresponding 80 COCO class IDs.
        lvis (bool, optional): Whether to convert data in lvis dataset way.

    Example:
        ```python
        from yolo.ultralytics.data.converter import convert_coco
    ...
    Output:
        Generates weight files in the specified weight directory.
    """
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    The converted masks are saved in the specified weight directory.
    ...
    Example:
        ```python
        from yolo.ultralytics.data.converter import convert_segment_masks_to_yolo_seg

        # The classes here is the total classes in the dataset, for COCO dataset we have 80 classes
        convert_segment_masks_to_yolo_seg("path/to/masks_directory", "path/to/weight/directory", classes=80)
        ```
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from yolo.ultralytics.data.converter import convert_dota_to_yolo_obb
...
def create_synthetic_coco_dataset():
    ...
    Examples:
        >>> from yolo.ultralytics.data.converter import create_synthetic_coco_dataset
