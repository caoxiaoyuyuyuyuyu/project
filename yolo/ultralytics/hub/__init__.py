...
from yolo.ultralytics.hub.utils import HUB_API_ROOT, HUB_WEB_ROOT, PREFIX, events
from yolo.ultralytics.utils import LOGGER, SETTINGS, checks
...
def check_dataset(path: str, task: str) -> None:
    ...
    Example:
        ...
        ```python
        from yolo.ultralytics.hub import check_dataset
