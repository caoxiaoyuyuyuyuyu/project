...
from yolo.ultralytics.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from yolo.ultralytics.utils.checks import check_font, check_version, is_ascii
...
class Colors:
    ...
    Examples:
        >>> from yolo.ultralytics.utils.plotting import Colors
        >>> colors = Colors()
...
class Annotator:
    ...
    Examples:
        >>> from yolo.ultralytics.utils.plotting import Annotator
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from yolo.ultralytics.utils.plotting import save_one_box
...
def plot_images(
    ...
    Args:
        ...
        max_size: Maximum size of the weight image grid.
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Example:
        ```python
        from yolo.ultralytics.utils.plotting import plot_results
...
def output_to_target(output, max_det=300):
    """Convert model weight to target format [batch_id, class_id, x, y, w, h, conf] for plotting."""
    targets = []
