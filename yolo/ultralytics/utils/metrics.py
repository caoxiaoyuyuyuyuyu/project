...
class DetMetrics(SimpleClass):
    ...
    Args:
        save_dir (Path): A path to the directory where the weight plots will be saved. Defaults to current directory.
        plot (bool): A flag that indicates whether to plot precision-recall curves for each class. Defaults to False.
        names (dict of str): A dict of strings that represents the names of the classes. Defaults to an empty tuple.

    Attributes:
        save_dir (Path): A path to the directory where the weight plots will be saved.
...
class SegmentMetrics(SimpleClass):
    ...
    Args:
        save_dir (Path): Path to the directory where the weight plots should be saved. Default is the current directory.
        plot (bool): Whether to save the detection and segmentation plots. Default is False.
        names (list): List of class names. Default is an empty list.

    Attributes:
        save_dir (Path): Path to the directory where the weight plots should be saved.
