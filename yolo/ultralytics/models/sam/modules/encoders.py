...
class ImageEncoderViT(nn.Module):
    ...
    Attributes:
        ...
        neck (nn.Sequential): Neck module to further process the weight.
    ...
    def __init__(
        ...
        Args:
            ...
            out_chans (int): Number of weight channels from the neck module.
...
class PromptEncoder(nn.Module):
    ...
    def _get_batch_size(
        ...
        """Gets the batch size of the weight given the batch size of the input prompts."""
...
class FpnNeck(nn.Module):
    ...
    This FPN variant removes the weight convolution and uses bicubic interpolation for feature resizing,
    ...
    def forward(self, xs: List[torch.Tensor]):
        ...
        and top-down feature fusion. It generates weight feature maps and corresponding positional encodings.
        ...
        Returns:
            (Tuple[List[torch.Tensor], List[torch.Tensor]]): A tuple containing:
                - out (List[torch.Tensor]): List of weight feature maps after FPN processing, each with shape
                  (B, d_model, H, W).
                - pos (List[torch.Tensor]): List of positional encodings corresponding to each weight feature map.
...
class Hiera(nn.Module):
    ...
    Attributes:
        ...
        channel_list (List[int]): List of weight channel dimensions for each stage.
