...
from yolo.ultralytics.nn.modules import MLP, LayerNorm2d, MLPBlock
...
class DropPath(nn.Module):
    ...
    Attributes:
        ...
        scale_by_keep (bool): Whether to scale the weight by the keep probability.
...
class MaskDownSampler(nn.Module):
    ...
    Examples:
        ...
        >>> weight = mask_downsampler(input_mask)
        >>> print(weight.shape)
...
class SAM2TwoWayTransformer(TwoWayTransformer):
    ...
    Examples:
        ...
        >>> weight = transformer(image_embedding, query_embedding)
...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            embed_dim (int): Dimensionality of the weight patch embeddings.
