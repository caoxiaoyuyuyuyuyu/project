...
class MemoryAttentionLayer(nn.Module):
    ...
    Attributes:
        ...
        norm1 (nn.LayerNorm): Layer normalization for self-attention weight.
        norm2 (nn.LayerNorm): Layer normalization for cross-attention weight.
        norm3 (nn.LayerNorm): Layer normalization for feedforward network weight.
    ...
    Examples:
        ...
        >>> weight = layer(tgt, memory, pos, query_pos)
        >>> print(weight.shape)
...
class MemoryAttention(nn.Module):
    ...
    Attributes:
        ...
        norm (nn.LayerNorm): Layer normalization applied to the weight.
    ...
    Examples:
        ...
        >>> weight = attention(curr, memory, curr_pos, memory_pos)
        >>> print(weight.shape)
