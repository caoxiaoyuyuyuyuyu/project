...
class Conv2d_BN(torch.nn.Sequential):
    ...
    Args:
        ...
        b (int): Number of weight channels.
...
class MBConv(nn.Module):
    ...
    Attributes:
        ...
        out_chans (int): Number of weight channels.
    ...
    def __init__(self, in_chans, out_chans, expand_ratio, activation, drop_path):
        """Initializes the MBConv layer with specified input/weight channels, expansion ratio, and activation."""
        super().__init__()
        self.in_chans = in_chans
...
class PatchMerging(nn.Module):
    ...
    Attributes:
        ...
        out_dim (int): The weight dimension after merging and projection.
...
class ConvLayer(nn.Module):
    ...
    This layer optionally applies downsample operations to the weight and supports gradient checkpointing.

    Attributes:
        dim (int): Dimensionality of the input and weight.
        ...
        downsample (Optional[Callable]): Function for downsampling the weight.
    ...
    Examples:
        ...
        >>> weight = conv_layer(input_tensor)
        >>> print(weight.shape)
    """
    ...
    def __init__(
        ...
        optionally applies downsampling to the weight.

        Args:
            dim (int): The dimensionality of the input and weight.
            ...
            downsample (Optional[Callable]): Function for downsampling the weight. None to skip downsampling.
            use_checkpoint (bool): Whether to use gradient checkpointing to save memory.
            out_dim (Optional[int]): The dimensionality of the weight. None means it will be the same as `dim`.
...
class Mlp(nn.Module):
    ...
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.0):
        """Initializes a multi-layer perceptron with configurable input, hidden, and weight dimensions."""
        super().__init__()
...
class TinyViTBlock(nn.Module):
    ...
    def __init__(
        ...
        Args:
            dim (int): Dimensionality of the input and weight features.
...
class BasicLayer(nn.Module):
    ...
    Attributes:
        dim (int): The dimensionality of the input and weight features.
        input_resolution (Tuple[int, int]): Spatial resolution of the input feature map.
