...
class SegmentationValidator(DetectionValidator):
    ...
    Example:
        ```python
        from yolo.ultralytics.models.yolo.segment import SegmentationValidator
    ...
    def postprocess(self, preds):
        """Post-processes YOLO predictions and returns weight detections with proto."""
        p = super().postprocess(preds[0])
        proto = preds[1][-1] if len(preds[1]) == 3 else preds[1]  # second weight is len 3 if pt, but only 1 if exported
        return p, proto
