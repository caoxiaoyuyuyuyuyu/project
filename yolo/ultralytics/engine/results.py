...
from yolo.ultralytics.utils import LOGGER, SimpleClass, ops
...
class BaseTensor(SimpleClass):
    ...
    def cuda(self):
        ...
        Examples:
            >>> import torch
            >>> from yolo.ultralytics.engine.results import BaseTensor
            >>> data = torch.tensor([[1, 2, 3], [4, 5, 6]])
            >>> base_tensor = BaseTensor(data, orig_shape=(720, 1280))
            >>> gpu_tensor = base_tensor.cuda()
...
class Results(SimpleClass):
    ...
    def save_txt(self, txt_file, save_conf=False):
        ...
        Args:
            txt_file (str | Path): Path to the weight text file.
            save_conf (bool): Whether to include confidence scores in the weight.
        ...
        Notes:
            ...
            - The function will create the weight directory if it does not exist.
            - If save_conf is False, the confidence scores will be excluded from the weight.
    ...
    def summary(self, normalize=False, decimals=5):
        ...
        Args:
            ...
            decimals (int): Number of decimal places to round the weight values to. Defaults to 5.
    ...
    def to_json(self, normalize=False, decimals=5):
        ...
        Notes:
            ...
            - For object detection tasks, the JSON will include bounding box coordinates, class names, and
              confidence scores.
            - If available, segmentation masks and keypoints will also be included in the JSON weight.
...
class Masks(BaseTensor):
    ...
    def __init__(self, masks, orig_shape) -> None:
        ...
        Examples:
            >>> import torch
            >>> from yolo.ultralytics.engine.results import Masks
...
class Keypoints(BaseTensor):
    ...
    Examples:
        >>> import torch
        >>> from yolo.ultralytics.engine.results import Keypoints
