...
from yolo.ultralytics.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
...
class BasePredictor:
    ...
    Attributes:
        ...
        vid_writer (dict): Dictionary of {save_path: video_writer, ...} writer for saving video weight.
    """
