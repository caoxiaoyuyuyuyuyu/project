...
from yolo.ultralytics.cfg import TASK2DATA, get_cfg
from yolo.ultralytics.data import build_dataloader
...
from yolo.ultralytics.nn.autobackend import check_class_names, default_class_names
from yolo.ultralytics.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from yolo.ultralytics.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
from yolo.ultralytics.utils import (
    ARM64,
    DEFAULT_CFG,
    IS_COLAB,
    IS_JETSON,
...
from yolo.ultralytics.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from yolo.ultralytics.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from yolo.ultralytics.utils.files import file_size, spaces_in_path
from yolo.ultralytics.utils.ops import Profile, nms_rotated, xywh2xyxy
from yolo.ultralytics.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device
...
def gd_outputs(gd):
    """TensorFlow GraphDef model weight node names."""
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if imx:
            from yolo.ultralytics.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from yolo.ultralytics.utils.tal import make_anchors
        ...
        LOGGER.info(
            ...
            f"weight shape(s) {self.output_shape} ({file_size(file):.1f} MB)"
        )
    ...
    def export_engine(self, dla=None, prefix=colorstr("TensorRT:")):
        ...
        for out in outputs:
            LOGGER.info(f'{prefix} weight "{out.name}" with shape{out.shape} {out.dtype}')
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        ...
        if f.is_dir():
            shutil.rmtree(f)  # delete weight folder
    ...
    def export_tfjs(self, prefix=colorstr("TensorFlow.js:")):
        ...
        LOGGER.info(f"\n{prefix} weight node names: {outputs}")
    ...
    def export_imx(self, prefix=colorstr("IMX:")):
        ...
        subprocess.run(
            ["imxconv-pt", "-i", str(onnx_model), "-o", str(f), "--no-input-persistency", "--overwrite-weight"],
            check=True,
        )
    ...
    def _pipeline_coreml(self, model, weights_dir=None, prefix=colorstr("CoreML Pipeline:")):
        ...
        else:  # linux and windows can not run model.predict(), get sizes from PyTorch model weight y
