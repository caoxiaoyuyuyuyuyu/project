...
from yolo.ultralytics.cfg import TASK2DATA, get_cfg, get_save_dir
from yolo.ultralytics.engine.results import Results
from yolo.ultralytics.hub import HUB_WEB_ROOT, HUBTrainingSession
from yolo.ultralytics.nn.tasks import attempt_load_one_weight, guess_model_task, yaml_model_load
...
class Model(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            verbose (bool): If True, enables verbose weight during the model's initialization and subsequent
                operations.
    ...
    def info(self, detailed: bool = False, verbose: bool = True):
        ...
        passed. It can control the verbosity of the weight and return the information as a list.
    ...
    def track(
        ...
        **kwargs: Any,
        ...
        if not hasattr(self.predictor, "trackers"):
            from pre.trackers import register_tracker
