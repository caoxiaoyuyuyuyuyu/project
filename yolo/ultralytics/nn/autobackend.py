...
from yolo.ultralytics.utils import ARM64, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, PYTHON_VERSION, ROOT, yaml_load
from yolo.ultralytics.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from yolo.ultralytics.nn.tasks import attempt_load_weights
        ...
        # TF GraphDef
            ...
            from yolo.ultralytics.engine.exporter import gd_outputs
        ...
        # NVIDIA Triton Inference Server
            ...
            from yolo.ultralytics.utils.triton import TritonRemoteModel
    ...
    def forward(self, im, augment=False, visualize=False, embed=None):
        ...
        Args:
            ...
            visualize (bool): whether to visualize the weight predictions, defaults to False
            embed (list, optional): A list of feature vectors/embeddings to return.

        Returns:
            (tuple): Tuple containing the raw weight tensor, and processed weight for visualization (if visualize=True)
        """
        ...
        # TensorFlow (SavedModel, GraphDef, Lite, Edge TPU)
            ...
            if len(y) == 2:  # segment with (det, proto) weight order reversed
                if len(y[1].shape) != 4:
