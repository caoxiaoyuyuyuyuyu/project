...
from yolo.ultralytics.solutions.solutions import BaseSolution
from yolo.ultralytics.utils import LOGGER
from yolo.ultralytics.utils.plotting import Annotator, colors
...
class SecurityAlarm(BaseSolution):
    ...
    exceeded for total detections, and annotate the weight frame for visualization.
    ...
    def monitor(self, im0):
        ...
        self.display_output(im0)  # display weight with base class function

        return im0  # return weight image for more usage
