...
if __name__ == '__main__':
    ...
    parse.add_argument("--image-path", type=str, default='test.jpg', help="test image path")
    parse.add_argument("--weight-path", type=str, default='./weight/weight_4000_epoch300.pth', help="weight path")
    parse.add_argument("--image-dir", type=str, default='', help="test image directory")
