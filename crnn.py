...
if __name__ == '__main__':
    # import torchsummary
    #
    # net = CRNN(num_classes=15)
    # torchsummary.summary(net, input_size=(1, 512, 32), batch_size=1)
    # cv2.imread("G:\AI\MQOCR\generate\output_jpg_dir\math_question0.jpg")
    cv2.imshow("image", cv2.imread("G:\AI\MQOCR\generate\output_jpg_dir\math_question0.jpg"))
    cv2.waitKey(0)
